# УП - Практикум 02 - 09.10.2025

### Задачи

#### Задача за Git:

1. Създайте си акаунт в GitHub, ако все още нямате.
2. Инсталирайте си локално git.
3. Създайте локално репозитори.
4. В репозиторито, създайте файл `first.txt` със съдържание някакъв произволен текст.
5. Push-нете файла и репозиторито в GitHub.
6. Направете си нов бранч.
7. В новия бранч, създайте нов файл `second.txt` с друго съдържание и го push-нете към remote.
8. Отворете Pull Request от новия бранч в GitHub.
10. Star-нете [репото на групата](https://github.com/StefanShivarov/introduction-to-programming-fmi-2025-26/) ⭐
9. Направете fork към него
